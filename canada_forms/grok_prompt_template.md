...
5.	Tên quốc gia/thành phố bằng tiếng Anh. VD: "Vietnam", "Ho Chi Minh City"
6.	accompanying = true nếu người đó ĐI CÙNG sang Canada
7.	NẾU NGƯỜI ĐÓ ĐÃ MẤT: Điền name, dob (nếu có), country_of_birth. Phần marital_status và occupation để null. Phần address ghi "Deceased + thời gian mất" (Ví dụ: "Deceased 24/10/1996" hoặc "Deceased 2001").
⚠️ CẤM TUYỆT ĐỐI:
...
JSON
{
  ...
  "applicant": {
    ...
    "address": "123 Nguyen Hue Street, Ben Nghe Ward, District 1, Ho Chi Minh City, Vietnam",
  ...
  "mother": {
    ...
    "dob": "1965-05-10",
    "country_of_birth": "Vietnam",
    "address": "45 Tran Phu Street, Ward 5, Vung Tau City, Ba Ria - Vung Tau Province, Vietnam",
    "occupation": "Retired",
    "marital_status": "Married",
    "accompanying": false
  },
  ...
  "siblings": [
    {
      ...
      "dob": "1988-06-15",
      "country_of_birth": "Vietnam",
      "address": "78 Le Loi Street, Ward 1, District 5, Ho Chi Minh City, Vietnam",
...
•	MỖI NGƯỜI phải có ĐỊA CHỈ ĐẦY ĐỦ riêng, KHÔNG được viết "same as applicant" (ngoại trừ trường hợp người đó đã mất thì ghi theo quy tắc Deceased).
